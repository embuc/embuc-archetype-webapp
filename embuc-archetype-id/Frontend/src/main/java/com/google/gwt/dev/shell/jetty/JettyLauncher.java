...
public class JettyLauncher extends ServletContainerLauncher {
  ...
  public static class JettyRequestLogger extends AbstractLifeCycle implements
    ...
    /**
     * Instantiates a new jetty request logger.
     *
     * @param logger the logger
     * @param normalLogLevel the normal log level
     */
  ...
  public static class JettyTreeLogger implements Logger {
    ...
    /**
     * Instantiates a new jetty tree logger.
     *
     * @param logger the logger
     */
     ...
     *
     * @param enabled the new debug enabled
  ...
  protected static class JettyServletContainer extends ServletContainer {
    ...
    /**
     * Instantiates a new jetty servlet container.
     *
     * @param logger the logger
     * @param server the server
     * @param wac the wac
     * @param actualPort the actual port
     * @param appRootDir the app root dir
     */
     ...
     *
     * @return the port
     * @see com.google.gwt.core.ext.ServletContainer#getPort()
     */
    @Override
    public int getPort() {
      return actualPort;
     ...
     * @see com.google.gwt.core.ext.ServletContainer#refresh()
     */
    @Override
     ...
     *
     * @throws UnableToCompleteException the unable to complete exception
     * @see com.google.gwt.core.ext.ServletContainer#stop()
     */
    @Override
  ...
  protected static final class WebAppContextWithReload extends WebAppContext {
    ...
    private class WebAppClassLoaderExtension extends WebAppClassLoader {
      ...
      /** The Constant META_INF_SERVICES. */
      private static final String META_INF_SERVICES = "META-INF/services/";

      /**
       * Instantiates a new web app class loader extension.
       *
      ...
      /**
       * Adds the containing class path entry.
       *
    ...
    /**
     * Instantiates a new web app context with reload.
     *
     * @param logger the logger
     ...
     * @see org.mortbay.jetty.webapp.WebAppContext#doStart()
     */
    @Override
     ...
     *
     * @throws Exception the exception
     * @see org.mortbay.jetty.webapp.WebAppContext#doStop()
     */
    @Override
   ...
   *
   * @return the name
   * @see com.google.gwt.core.ext.ServletContainerLauncher#getName()
   */
  @Override
   ...
   * @see com.google.gwt.core.ext.ServletContainerLauncher#isSecure()
   */
  @Override
   ...
   * @return true, if successful
   * @see com.google.gwt.core.ext.ServletContainerLauncher#processArguments(com.google.gwt.core.ext.TreeLogger, java.lang.String)
   */
  @Override
   ...
   */
  /**
   * Sets the base request log level.
   *
   * @param baseLogLevel the new base request log level
   */
   ...
   *
   * @param bindAddress the new bind address
   * @see com.google.gwt.core.ext.ServletContainerLauncher#setBindAddress(java.lang.String)
   */
  @Override
   ...
   * @throws Exception the exception
   * @see com.google.gwt.core.ext.ServletContainerLauncher#start(com.google.gwt.core.ext.TreeLogger, int, java.io.File)
   */
...
@Override
   ...
   * @return the jetty servlet container
   */
